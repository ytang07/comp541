...
# Initialize Board
initGame:
	add $s0, $0, $0			# Cursor Column, cursor col is s0 = 0
	add $s1, $0, $0			# Cursor Row, cursor row is s1 = 0
	addi $s2, $0, 20		# Selected Column, selected col is s2 = 20
	addi $s3, $0, 20		# Selected Row, selected row is s3 = 20
...
swapTakePiece:
	...
	add $a0, $0, $t6		# Charcode
	addi $a1, $0, 10		# Cursor Column
	addi $a2, $0, 2			# Cursor Row
	jal putChar_atXY
	add $a0, $0, $t7		# Charcode
	addi $a1, $0, 11		# Cursor Column
	addi $a2, $0, 2			# Cursor Row
	jal putChar_atXY
...
initSelector:
	...
	addi $a1, $0, 10		# Cursor Column, a1 = cursor col = 10
	addi $a2, $0, 0			# Cursor Row, a2 = cursor row = 0
	jal putChar_atXY
